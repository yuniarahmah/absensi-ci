      ...
      <table class="table">
        ...
        <tbody classs="table-grup-divider">
          ...
          <tr>
            ...
            <td><?php echo tampil_full_mapel($row->id_mapel)?></td>
            <td>
                <a href="<?php echo base_url('admin/ubah_guru/'). $row->id_guru?>" class="btn btn-primary"><i class="fa-solid fa-square-pen"></i></a>
