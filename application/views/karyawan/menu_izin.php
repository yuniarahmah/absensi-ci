...
<form class="d-flex" role="search">
  ...
  <a href="/absensii/karyawan/karyawan" class="w3-bar-item w3-button"><span class="ms-1 d-none d-sm-inline">History</span></a>
...
<div class="card w-50 p-5 " style="margin-left:23%">
  <h5 class="card-title" style="margin-left:23%">Menu izin</h5>
  <div class="card-body">
