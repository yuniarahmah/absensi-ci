    ...
    <div class="collapse navbar-collapse">
      <ul class="navbar-nav">
        <li class="nav-item">
          ...
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT0uG-zn_mMio70r-16wNQG5HLuOUgvBAvTj2KXnc_lM3s1qyJyRuYZOsac3vPir5wUO-s&usqp=CAU" style="width:90px;">
        ...
        <div class="col-12 bg-dark" style="width: 15%;">
            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                <a href="" class="d-flex align-items-center pb-3 mb-md-0 me-md-auto text-white text-decoration-none">
                  <span class="fs-5 d-none d-sm-inline" style="background-bisque">DAHBOARD KARYAWAN</span>
                </a>
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    ...
                    <li>
                        <a href="/absensii/admin/" data-bs-toggle="collapse" class="nav-link px-0 align-middle">
                    ...
                    <li>
                        <a href="<?php echo base_url('karyawan/karyawan') ?>" class="nav-link px-0 align-middle">
                            <i class="fa-solid fa-graduation-cap"></i> <span class="ms-1 d-none d-sm-inline">Karyawan</span></a>
                    </li>
                    <li>
                        <a href="<?php echo base_url('karyawan/absen') ?>" class="nav-link px-0 align-middle">
                            <i class="fa-solid fa-house-user"></i> <span class="ms-1 d-none d-sm-inline">Absen</span></a>
                    </li>
                </ul>
                <hr>
              </div>
